...
public class CommandCreate implements ISubCommand
{
	...
	public String[] helpInfo(EntityPlayer sender) {
		return new String[]
		{
			"Usage: /tt-schematic create <name> [-o] or [client]",
			"",
			"Creates a schematic of the selected area with the given name",
			"add \"-o\" to overwrite an existing schematic with the given name",
